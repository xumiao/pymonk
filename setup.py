...
setup(
    ...
    description='MONK Python project',
    long_description='Margin-based Object Network Kit (MONK)',

    # The project's main homepage.
    url='https://github.com/xumiao/pymonk',

    # Author details
    author='monklab',
    author_email='monklab0@gmail.com',

    # Choose your license
    license='MIT',
    
    # Scripts to run
    scripts=['bin/monkupgrade.sh', 'bin/monkworkers.sh', 'bin/monkkill.sh'],
    ...
    # Cython modules
    ext_modules=cythonize("monk/math/*.pyx"),
